  ...
  return (
    <div className="grid min-h-[80vh] place-items-center px-6">
      <div className="text-center max-w-md">
        <div className="mx-auto grid h-20 w-20 place-items-center rounded-3xl bg-brand-100 dark:bg-brand-800">
          <FileQuestion size={36} className="text-brand-500" />
        </div>
        <h1 className="mt-6 font-display text-5xl font-medium text-ink">404</h1>
