        ...
        {loading ? (
          ...
          acts.map((a) => {
            ...
            return (
              <div
                key={a.id}
                className="flex items-start gap-2.5 rounded-xl border border-brand-200 p-2.5"
              >
                <span className="mt-0.5 grid h-7 w-7 shrink-0 place-items-center rounded-xl bg-brand-100 text-brand-500 dark:bg-white/8">
                  <Icon size={14} />
                </span>
