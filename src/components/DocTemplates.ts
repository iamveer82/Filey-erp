...
export const DOC_TEMPLATES = [
  ...
  // UAE pack wave 2 — industry & special-case documents; additive.
  { id: "uae-construction", name: "UAE Construction Progress" },
  { id: "uae-rental", name: "UAE Rental / Lease" },
  { id: "uae-restaurant", name: "UAE Restaurant" },
  { id: "uae-medical", name: "UAE Medical" },
  { id: "uae-education", name: "UAE Education" },
  { id: "uae-logistics", name: "UAE Logistics" },
  { id: "uae-ecommerce", name: "UAE E-Commerce" },
  { id: "uae-hotel", name: "UAE Hotel Folio" },
  { id: "uae-salon", name: "UAE Salon" },
  { id: "uae-garage", name: "UAE Auto Garage" },
  { id: "uae-realestate", name: "UAE Real Estate Commission" },
  { id: "uae-amc", name: "UAE Annual Maintenance Contract" },
  { id: "uae-event", name: "UAE Event" },
  { id: "uae-timesheet", name: "UAE IT Timesheet" },
  { id: "uae-margin", name: "UAE Margin Scheme" },
  { id: "uae-summary", name: "UAE Summary Invoice" },
  { id: "uae-agent", name: "UAE Disclosed Agent" },
  { id: "uae-designated", name: "UAE Designated Zone" },
  { id: "uae-deemed", name: "UAE Deemed Supply" },
  { id: "uae-commercial", name: "UAE Commercial Invoice" },
  { id: "uae-petty-cash", name: "UAE Petty Cash Voucher" },
  { id: "uae-advance-receipt", name: "UAE Advance Payment Receipt" },
];
