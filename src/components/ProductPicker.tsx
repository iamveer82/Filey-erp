  ...
  return (
    <div className="flex gap-4 flex-col lg:flex-row">
          ...
          {filtered.map((p) => (
            <motion.div
              ...
              className={cn(
                ...
                "p-3 rounded-xl bg-white border border-brand-200 dark:bg-[#201D16] dark:border-[#322E25]",
              ...
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {p.category && (
                      <span className="pill bg-brand-100 text-brand-600 dark:bg-white/10 dark:text-[#C9C0B0]">
                        {p.category}
                      </span>
                    )}
                  </div>
      ...
      <motion.div
        ...
        className="w-full lg:w-72 shrink-0 flex flex-col rounded-2xl bg-white border border-brand-200 shadow-bento p-4 dark:bg-[#201D16] dark:border-[#322E25]"
      >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      className="p-1 rounded-md text-brand-400 hover:bg-white hover:text-ink dark:hover:bg-white/10 dark:hover:text-[#ECE7DD] transition-colors cursor-pointer"
                    >
                      <X size={12} />
                    </button>
                  </div>
                  <div className="flex items-center justify-between mt-1">
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="p-1 rounded-md text-brand-500 hover:bg-white hover:text-ink dark:hover:bg-white/10 dark:hover:text-[#ECE7DD] transition-colors cursor-pointer"
                      >
                        <Minus size={12} />
                      </button>
                      <motion.span
        ...
        <motion.div
          layout
          className="pt-3 mt-3 border-t border-brand-100 dark:border-[#2A261E]"
        >
