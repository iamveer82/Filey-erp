...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center gap-2 rounded-lg px-2 py-1.5 text-sm text-ink outline-none transition-colors focus:bg-brand-50 data-[state=open]:bg-brand-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-40 overflow-hidden rounded-xl border border-brand-200 bg-white p-1 text-ink shadow-bento",
      className
    )}
    {...props}
  />
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      "relative flex cursor-pointer select-none items-center rounded-lg py-1.5 pl-8 pr-2 text-sm text-ink outline-none transition-colors focus:bg-brand-50 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
    )}
    checked={checked}
    {...props}
...
const DropdownMenuShortcut = ({
  ...
  <span
    className={cn(
      "-me-1 ms-auto inline-flex h-5 max-h-full items-center rounded border border-brand-200 bg-brand-50 px-1 font-[inherit] text-[0.625rem] font-medium text-brand-400",
      className
    )}
    {...props}
  />
